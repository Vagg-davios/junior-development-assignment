    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div class="border-dashed border-2 rounded-lg p-4">
                ...
                <a href="/junior-development-assignment/public/book?id=<?=$book["book_id"]?>" class="inline-flex px-4 py-2 w-64 text-base font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
